...
//Impresion del camino mas corto desde la ciudad de salida hasta la ciudad de destino
...
void dijkstra( int inicial ){
    ...
    printf( "Distancias mas cortas iniciando en Ciudad %d\n" , inicial );
    for( int i = 1 ; i <= V ; ++i ){
        printf("Ciudad %d , distancia mas corta = %d\n" , i , distancia[ i ] );
    }
